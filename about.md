...
<div class="about-bio">
  <div class="about-photo">
    <img src="{{ site.baseurl }}/assets/headshot.JPG" alt="Cailin Plunkett">
  </div>
...
<div class="about-hobbies">
  ...
  <div class="photo-grid">
    ...
    <figure class="photo-slot">
      ...
      <figcaption>Mango, the world's most glorious cat</figcaption>
    </figure>
    <figure class="photo-slot">
      <img src="{{ site.baseurl }}/assets/about/cake.jpg" alt="Bake-off cake">
      <figcaption>Bake-off cake (December 2025)</figcaption>
    </figure>
    <figure class="photo-slot">
      <img src="{{ site.baseurl }}/assets/about/cookies.jpg" alt="Cookies">
      <figcaption>My alternate calling</figcaption>
    </figure>
  </div>
</div>
